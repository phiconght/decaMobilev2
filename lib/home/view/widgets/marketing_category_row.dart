...
/// co the bam "Đăng ký" tru Xu + vao lop ngay, hoac bam vao the de mo trang
/// chi tiet/dang ky chuyen khoan (xem CourseDetailPage — da khoi phuc onTap,
/// yeu cau nguoi dung 14/09/2026).
...
class _MarketingCourseCardState extends State<_MarketingCourseCard> {
  ...
  Widget build(BuildContext context) {
    ...
    final teacher = course.teacherNames.isNotEmpty
        ? course.teacherNames.first
        : null;
        ...
        child: Column(
          ...
          children: [
            ...
            if (registrable) ...[
              ...
              Text(
                '${_money.format(course.fullPrice)}đ',
                style: theme.textTheme.labelMedium?.copyWith(
                  fontWeight: FontWeight.w800,
                  fontSize: 11,
                ),
